...
classdef THzImageReconstruction < handle
    properties
        ...
        dBTh = 0                    % Threshold to set all pixles greater than equal to 0 (flattens surface to some threshold below 0 dB)
        ...
        isIso = false               % Boolean whether or not to plot the iso surface 3-D image

        im_method = "nearest"       % Interpolation method for image interpolation
        stolt_method = "linear"     % Interpolation method for Stolt interpolation
    ...
    methods
        ...
        function obj = Get(obj)
            ...
            switch obj.method
                ...
                case "Uniform 1-D SAR 1-D FFT EMPM"
                    obj.reconstructor = uniform_Y_SAR_YZ_RMA_EMPM(obj);

                case "Uniform 1-D SAR 2-D RMA EMPM"
                    obj.reconstructor = uniform_Y_SAR_YZ_RMA_EMPM(obj);

                case "Uniform 2-D SAR 2-D FFT EMPM"
                    obj.reconstructor = uniform_XY_SAR_XY_FFT_EMPM(obj);

                case "Uniform 2-D SAR 3-D RMA EMPM"
                    obj.reconstructor = uniform_XY_SAR_XYZ_RMA_EMPM(obj);
