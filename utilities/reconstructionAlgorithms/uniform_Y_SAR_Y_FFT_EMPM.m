% uniform_Y_SAR_Y_FFT_EMPM is a reconstructor class that performs a 1-D FFT
% method image reconstruction using EMPM algorithm introduced
...
classdef uniform_Y_SAR_Y_FFT_EMPM < handle
    properties
    ...
    methods
        function obj = uniform_Y_SAR_Y_FFT_EMPM(im)
        ...
        function reconstruct(obj)
            % Reconstruct the image using the 1-D FFT with fast freehand
            % method
            ...
            % sarData is of size (scanner.numY, fmcw.Nk) Zero-Pad Data:
            % s(y,k)
