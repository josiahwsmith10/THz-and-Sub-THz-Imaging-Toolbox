% uniform_Y_SAR_YZ_RMA_EMPM is a reconstructor class that performs a 2-D Range
...
classdef uniform_Y_SAR_YZ_RMA_EMPM < handle
    properties
    ...
    methods
        function obj = uniform_Y_SAR_YZ_RMA_EMPM(im)
