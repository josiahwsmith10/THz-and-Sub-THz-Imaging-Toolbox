...
classdef nonuniform_XY_SAR_XY_BPA < handle
    ...
    methods
        function obj = nonuniform_XY_SAR_XY_BPA(im)
        ...
        function getParameters(obj)
            ...
            [X,Y,Z] = ndgrid(obj.im.x_m(:),obj.im.y_m(:),obj.zSlice_m);
            obj.sizeTarget = [obj.im.numX,obj.im.numY,1];
        ...
        function displayImage(obj)
            % Display the x-y reconstructed image
