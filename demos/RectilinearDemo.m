% RectilinearDemo - A short demonstration of the rectilinear scan
...
target.png.xStep_m = 4e-4;
target.png.yStep_m = 4e-4;
target.png.xOffset_m = -0.005;
target.png.yOffset_m = 0.005;
target.png.zOffset_m = 0.1;
