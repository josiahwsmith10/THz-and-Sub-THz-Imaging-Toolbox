...
classdef nonuniform_thetaY_CSAR_XYZ_BPA_app < handle
    ...
    methods
        function obj = nonuniform_thetaY_CSAR_XYZ_BPA_app(app,im)
        ...
        function obj = verifyReconstruction(obj,app)
            ...
            if app.sar.method ~= "Cylindrical"
                uiconfirm(app.UIFigure,"Must use 2-D θY Cylindrical CSAR scan to use 2-D CSAR 3-D BPA image reconstruction method!",'SAR Scenario Error!',...
